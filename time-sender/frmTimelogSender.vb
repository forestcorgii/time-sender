...
Imports sean_workers

Public Class frmTimelogSender
    Private databaseManager As New manager_mysql.manager
    ...
    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        messengers = New Workers(1000)
        messengers.SetWorker(1)
        databaseManager = manager_mysql.manager.StartDefaultSetup(Application.StartupPath, My.Application.Info.AssemblyName)
    ...
    Private Sub btnDatabaseConf_Click(sender As Object, e As EventArgs) Handles btnDatabaseConf.Click
        ...
        databaseManager = manager_mysql.manager.OpenEditor(databaseManager, Application.StartupPath, My.Application.Info.AssemblyName)
    End Sub
    Private Sub btnGeneralConf_Click(sender As Object, e As EventArgs) Handles btnGeneralConf.Click
        Using genconfForm As New sfrmConfig(generalConfig, genConfFilepath)
            If genconfForm.ShowDialog() = DialogResult.OK Then
